                ...
                {menus.length === 0 ? (
                    ...
                    <>
                        {menus.map((menuReview) => {
                            return <RestaurantMenu key={menuReview.food_id} {...menuReview} />;
                        })}
                    </>
                )}
            </Animated.ScrollView>
            <Animated.View
                ...
                <Animated.View style={[styles.headerContainer, { opacity: imageOpacity }]}>
                    <View style={styles.foodInfoContainer}>
                        <View><Text style={styles.foodNameStyle}>{name}</Text></View>
                    </View>
                ...
                <Animated.View style={{ opacity: imageOpacity }}>
                    <View style={{ justifyContent: 'center', alignItems: 'center', height: 43, backgroundColor: '#EE5757' }}>
                        <Text style={{ color: '#FFFFFF', fontSize: 18, fontWeight: '700' }}>Menu</Text>
                    </View>
                </Animated.View>
            </Animated.View>
            <Animated.View
