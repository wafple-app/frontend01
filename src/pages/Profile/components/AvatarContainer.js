...
import AvartarImage from './AvartarImage';
...
const AvatarContainer = ( props ) => {
    ...
    return (
        <View style={{ flex: 1, flexWrap: 'wrap', flexDirection: 'row', paddingHorizontal: 10, paddingVertical: 10 }}>
            {AVARTAR_IMAGES.map((avaterImage) => {
                return <AvartarImage key={avaterImage} imageName={avaterImage} />
            })}
        </View>
        ...
        //     </View>
        //     <View style={{ flex: 1 }}>
        //         {AVARTAR_IMAGES.map((avarterImage) => {
        //             return <AvartarImage key={avarterImage} imageName={avarterImage} />
        //         })}
        //     </View>
